                                    ...
                                    <div class="form-check">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox"
                                                ...
                                                checked name="customCheck" id="checkboxGlow1">
                                            <label class="form-check-label"
                                                for="checkboxGlow1">Primary</label>
                                        </div>
                                    </div>
                                </li>
                                <li class="d-inline-block me-2 mb-1">
                                    <div class="form-check">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox"
                                                ...
                                                checked name="customCheck" id="checkboxGlow2">
                                            <label class="form-check-label"
                                                for="checkboxGlow2">Secondary</label>
                                        </div>
                                    </div>
                                </li>
                                <li class="d-inline-block me-2 mb-1">
                                    <div class="form-check">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox"
                                                ...
                                                checked name="customCheck" id="checkboxGlow3">
                                            <label class="form-check-label"
                                                for="checkboxGlow3">Success</label>
                                        </div>
                                    </div>
                                </li>
                                <li class="d-inline-block me-2 mb-1">
                                    <div class="form-check">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox"
                                                ...
                                                checked name="customCheck" id="checkboxGlow4">
                                            <label class="form-check-label"
                                                for="checkboxGlow4">Danger</label>
                                        </div>
                                    </div>
                                </li>
                                <li class="d-inline-block me-2 mb-1">
                                    <div class="form-check">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox"
                                                ...
                                                checked name="customCheck" id="checkboxGlow5">
                                    ...
                                    <div class="form-check">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox"
                                                ...
                                                checked name="customCheck" id="checkboxGlow6">
                                            <label class="form-check-label"
                                                for="checkboxGlow6">Warning</label>
                                        </div>
                                    </div>
                                </li>
                            </ul>
